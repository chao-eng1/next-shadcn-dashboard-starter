...
export function MessageNotificationDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        className={cn(
          'mx-auto max-w-md transform transition-all duration-300 ease-out',
      ...
      >
            ...
            <div className='flex items-center gap-3'>
              <div className='relative'>
                <div className='flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600'>
                  <Bell className='h-5 w-5 animate-pulse text-white' />
                </div>
                <div className='absolute -top-1 -right-1 h-4 w-4 animate-bounce rounded-full border-2 border-white bg-red-500'>
        ...
        <div className='space-y-4 py-4'>
          ...
          <div className='rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800/50'>
            <DialogDescription className='line-clamp-3 text-sm leading-relaxed text-gray-700 dark:text-gray-300'>
              {message.content}
            </DialogDescription>
          </div>
        </div>
        ...
        <DialogFooter className='flex-col gap-2 pt-4 sm:flex-row'>
          ...
          <Button
            onClick={onView}
            className='w-full border-0 bg-gradient-to-r from-blue-500 to-purple-600 text-white hover:from-blue-600 hover:to-purple-700 sm:w-auto'
          >
        ...
        {/* 自动关闭进度条 */}
        <div className='absolute right-0 bottom-0 left-0 h-1 overflow-hidden rounded-b-lg bg-gray-200 dark:bg-gray-700'>
          <div
            className='h-full rounded-b-lg bg-gradient-to-r from-blue-500 to-purple-600'
            style={{
