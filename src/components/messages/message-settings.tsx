...
export function MessageSettings() {
  ...
  // 添加关键词
  const addKeyword = () => {
    if (newKeyword.trim() && !notificationSettings.groupMessages.keywords.includes(newKeyword.trim())) {
  ...
  // 计算存储使用百分比
  const storagePercentage = (storageSettings.usedStorage / storageSettings.totalStorage) * 100;
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
          <div className="border-b">
            <TabsList className="h-12 w-full justify-start rounded-none bg-transparent p-0">
              ...
              <TabsTrigger value="privacy" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">接收所有类型的消息通知</p>
                      </div>
                      <Switch
                        id="enable-notifications"
                        checked={notificationSettings.enableNotifications}
                        onCheckedChange={(checked) => {
                          setNotificationSettings(prev => ({ ...prev, enableNotifications: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setNotificationSettings(prev => ({ ...prev, enableDesktopNotifications: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">发送移动端推送通知</p>
                      </div>
                      <Switch
                        id="enable-mobile"
                        checked={notificationSettings.enableMobileNotifications}
                        onCheckedChange={(checked) => {
                          setNotificationSettings(prev => ({ ...prev, enableMobileNotifications: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setNotificationSettings(prev => ({
                            ...prev,
                            privateMessages: { ...prev.privateMessages, enabled: checked }
                          }));
                          setHasChanges(true);
                        }}
                      />
                    ...
                    {notificationSettings.privateMessages.enabled && (
                      <div className="space-y-3 pl-4 border-l-2 border-muted">
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => {
                              setNotificationSettings(prev => ({
                                ...prev,
                                privateMessages: { ...prev.privateMessages, sound: checked }
                              }));
                              setHasChanges(true);
                            }}
                          />
                        ...
                        <div className="flex items-center justify-between">
                          <Label>桌面通知</Label>
                          <Switch
                            checked={notificationSettings.privateMessages.desktop}
                            onCheckedChange={(checked) => {
                              setNotificationSettings(prev => ({
                                ...prev,
                                privateMessages: { ...prev.privateMessages, desktop: checked }
                              }));
                              setHasChanges(true);
                            }}
                          />
                        ...
                        <div className="flex items-center justify-between">
                          <Label>仅VIP联系人</Label>
                          <Switch
                            checked={notificationSettings.privateMessages.vipOnly}
                            onCheckedChange={(checked) => {
                              setNotificationSettings(prev => ({
                                ...prev,
                                privateMessages: { ...prev.privateMessages, vipOnly: checked }
                              }));
                              setHasChanges(true);
                            }}
                          />
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setNotificationSettings(prev => ({
                            ...prev,
                            groupMessages: { ...prev.groupMessages, enabled: checked }
                          }));
                          setHasChanges(true);
                        }}
                      />
                    ...
                    {notificationSettings.groupMessages.enabled && (
                      <div className="space-y-3 pl-4 border-l-2 border-muted">
                        <div className="flex items-center justify-between">
                          <Label>仅@我时通知</Label>
                          <Switch
                            checked={notificationSettings.groupMessages.mentionOnly}
                            onCheckedChange={(checked) => {
                              setNotificationSettings(prev => ({
                                ...prev,
                                groupMessages: { ...prev.groupMessages, mentionOnly: checked }
                              }));
                              setHasChanges(true);
                            }}
                          />
                        ...
                        <div className="flex items-center justify-between">
                          <Label>关键词通知</Label>
                          <Switch
                            checked={notificationSettings.groupMessages.keywordNotification}
                            onCheckedChange={(checked) => {
                              setNotificationSettings(prev => ({
                                ...prev,
                                groupMessages: { ...prev.groupMessages, keywordNotification: checked }
                              }));
                              setHasChanges(true);
                            }}
                          />
                        ...
                        {notificationSettings.groupMessages.keywordNotification && (
                          <div>
                            ...
                            <div className="mt-2 space-y-2">
                              ...
                              <div className="flex flex-wrap gap-2">
                                {notificationSettings.groupMessages.keywords.map((keyword) => (
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setNotificationSettings(prev => ({
                            ...prev,
                            doNotDisturb: { ...prev.doNotDisturb, enabled: checked }
                          }));
                          setHasChanges(true);
                        }}
                      />
                    ...
                    {notificationSettings.doNotDisturb.enabled && (
                      <div className="space-y-3 pl-4 border-l-2 border-muted">
                        ...
                        <div className="flex items-center justify-between">
                          <Label>紧急消息绕过</Label>
                          <Switch
                            checked={notificationSettings.doNotDisturb.emergencyBypass}
                            onCheckedChange={(checked) => {
                              setNotificationSettings(prev => ({
                                ...prev,
                                doNotDisturb: { ...prev.doNotDisturb, emergencyBypass: checked }
                              }));
                              setHasChanges(true);
                            }}
                          />
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>显示在线状态</Label>
                        <p className="text-sm text-muted-foreground">让其他人看到您的在线状态</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">显示您最后一次在线的时间</p>
                      </div>
                      <Switch
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>允许群组邀请</Label>
                        <p className="text-sm text-muted-foreground">允许他人邀请您加入群组</p>
                      </div>
                      <Switch
                        checked={privacySettings.allowGroupInvites}
                        onCheckedChange={(checked) => {
                          setPrivacySettings(prev => ({ ...prev, allowGroupInvites: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>已读回执</Label>
                        <p className="text-sm text-muted-foreground">发送已读状态给对方</p>
                      </div>
                      <Switch
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>输入状态指示器</Label>
                        <p className="text-sm text-muted-foreground">显示"正在输入"状态</p>
                      </div>
                      <Switch
                        checked={privacySettings.typingIndicators}
                        onCheckedChange={(checked) => {
                          setPrivacySettings(prev => ({ ...prev, typingIndicators: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>显示头像</Label>
                        <p className="text-sm text-muted-foreground">在聊天中显示您的头像</p>
                      </div>
                      <Switch
                        checked={privacySettings.showProfilePhoto}
                        onCheckedChange={(checked) => {
                          setPrivacySettings(prev => ({ ...prev, showProfilePhoto: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>显示个人信息</Label>
                        <p className="text-sm text-muted-foreground">允许他人查看您的个人信息</p>
                      </div>
                      <Switch
                        checked={privacySettings.showPersonalInfo}
                        onCheckedChange={(checked) => {
                          setPrivacySettings(prev => ({ ...prev, showPersonalInfo: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: 'light' | 'dark' | 'auto') => {
                          setChatSettings(prev => ({ ...prev, theme: value }));
                          setHasChanges(true);
                        }}
                      >
                        <SelectTrigger className="mt-2">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setChatSettings(prev => ({ ...prev, autoDownloadImages: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setChatSettings(prev => ({ ...prev, autoDownloadVideos: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          setChatSettings(prev => ({ ...prev, autoDownloadAudio: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value: 'low' | 'medium' | 'high') => {
                          setChatSettings(prev => ({ ...prev, mediaQuality: value }));
                          setHasChanges(true);
                        }}
                      >
                        <SelectTrigger className="mt-2">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        <span>已使用</span>
                        <span>{formatStorage(storageSettings.usedStorage)} / {formatStorage(storageSettings.totalStorage)}</span>
                      </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>自动删除旧消息</Label>
                        <p className="text-sm text-muted-foreground">自动删除超过指定天数的消息</p>
                      </div>
                      <Switch
                        checked={storageSettings.autoDeleteOldMessages}
                        onCheckedChange={(checked) => {
                          setStorageSettings(prev => ({ ...prev, autoDeleteOldMessages: checked }));
                          setHasChanges(true);
                        }}
                      />
                    </div>
                    ...
                    {storageSettings.autoDeleteOldMessages && (
                      <div className="pl-4 border-l-2 border-muted">
                        ...
                        <Input
                          ...
                          onChange={(e) => {
                            setStorageSettings(prev => ({ ...prev, autoDeleteDays: parseInt(e.target.value) || 90 }));
                            setHasChanges(true);
                          }}
                          className="mt-2"
                        />
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <Label>自动备份</Label>
                        <p className="text-sm text-muted-foreground">定期备份您的消息数据</p>
                      </div>
                      <Switch
                      ...
                      <div className="space-y-3 pl-4 border-l-2 border-muted">
                        <div>
                          ...
                          <Select
                            ...
                            onValueChange={(value: 'daily' | 'weekly' | 'monthly') => {
                              setStorageSettings(prev => ({ ...prev, backupFrequency: value }));
                              setHasChanges(true);
                            }}
                          >
                            <SelectTrigger className="mt-2">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(checked) => {
                              setStorageSettings(prev => ({ ...prev, includeMedia: checked }));
                              setHasChanges(true);
                            }}
                          />
                        </div>
