        ...
        if (result.success) {
          ...
          tasks.forEach((task: any) => {
            ...
            if (
              ...
              const dayIndex = Math.floor(
                (updatedDate.getTime() - startDate.getTime()) /
                  (1000 * 60 * 60 * 24)
              );
              if (dayIndex >= 0 && dayIndex < days) {
      ...
      <CardContent>
        ...
        <div className='mt-4 grid grid-cols-3 gap-4 text-center'>
          <div className='space-y-1'>
            ...
            <div className='text-muted-foreground text-xs'>总新建</div>
          </div>
          <div className='space-y-1'>
            <div
            ...
            <div className='text-muted-foreground text-xs'>总进行中</div>
          </div>
          <div className='space-y-1'>
            <div
              className='text-2xl font-bold'
            ...
            <div className='text-muted-foreground text-xs'>总完成</div>
          </div>
        </div>
      </CardContent>
    </Card>
