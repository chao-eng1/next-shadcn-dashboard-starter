...
export function RequirementDependencyGraph({
  ...
  const fetchGraphData = async () => {
    try {
      ...
      const response = await fetch(
        `/api/requirements/dependency-graph?${params}`
      );
      if (!response.ok) {
  ...
  const filteredNodes = graphData.nodes.filter((node) => {
    ...
    const matchesPriority =
      filterPriority === 'all' || node.priority === filterPriority;
    ...
    <div className='space-y-4'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-2'>
          <Select
            value={layoutType}
            onValueChange={(value: any) => setLayoutType(value)}
          >
            <SelectTrigger className='w-32'>
              <SelectValue />
            </SelectTrigger>
      ...
      <Card>
        ...
        <CardContent>
          ...
          >
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <div className='space-y-1 text-sm'>
                          ...
                          {node.assignee && (
                            <p className='text-muted-foreground'>
                              负责人: {node.assignee.name}
                            </p>
                          )}
                          {node.project && (
                            <p className='text-muted-foreground'>
                              项目: {node.project.name}
                            </p>
                          )}
                          {node.effort && (
                            <p className='text-muted-foreground'>
            ...
            {/* 缩放控制 */}
            <div className='absolute right-4 bottom-4 rounded-lg bg-white p-2 shadow-lg'>
            ...
            {/* 图例 */}
            <div className='absolute top-4 left-4 space-y-2 rounded-lg bg-white p-3 shadow-lg'>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-muted-foreground text-sm'>需求节点</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-muted-foreground text-sm'>依赖关系</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-muted-foreground text-sm'>阻塞关系</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-muted-foreground text-sm'>独立需求</p>
            </div>
          </CardContent>
        </Card>
      </div>
