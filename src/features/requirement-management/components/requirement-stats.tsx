...
export function RequirementStats({ projectId }: RequirementStatsProps) {
  ...
  const getStatusData = () => {
    ...
    return Object.entries(stats.byStatus).map(([status, count]) => ({
      ...
      value: count,
      color:
        statusConfig[status as keyof typeof statusConfig]?.color || '#6B7280'
    }));
  };
  ...
  const getComplexityData = () => {
    ...
    return Object.entries(stats.byComplexity).map(([complexity, count]) => ({
      ...
      value: count,
      color:
        complexityConfig[complexity as keyof typeof complexityConfig]?.color ||
        '#6B7280'
    }));
  };
  ...
  const getEfficiencyRate = () => {
    ...
    return Math.round(
      (stats.totalActualEffort / stats.totalEstimatedEffort) * 100
    );
  };
  ...
  const getMonthlyGrowth = () => {
    ...
    return lastMonthCreated > 0
      ? Math.round(
          ((stats.createdThisMonth - lastMonthCreated) / lastMonthCreated) * 100
        )
      : 0;
  };
    ...
    return (
      <Card>
        <CardContent className='flex flex-col items-center justify-center py-12'>
          ...
          <h3 className='mb-2 text-lg font-medium'>暂无统计数据</h3>
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4'>
        <Card className='border-0 bg-gradient-to-br from-blue-50 to-indigo-50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-blue-950/20 dark:to-indigo-950/20'>
          ...
          <CardContent>
            ...
            <div className='mt-2 flex items-center gap-2'>
              ...
              <span className='text-muted-foreground text-xs'>本月新增</span>
            </div>
          </CardContent>
        </Card>

        <Card className='border-0 bg-gradient-to-br from-green-50 to-emerald-50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-green-950/20 dark:to-emerald-950/20'>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-3'>
        ...
        <Card className='border-0 bg-gradient-to-br from-red-50 to-pink-50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-red-950/20 dark:to-pink-950/20'>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-3'>
        ...
        <Card className='border-0 bg-gradient-to-br from-purple-50 to-violet-50 shadow-lg transition-all duration-300 hover:shadow-xl dark:from-purple-950/20 dark:to-violet-950/20'>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-3'>
          ...
          <CardContent>
            ...
            <div className='text-muted-foreground mt-2 text-xs'>
              实际 {stats.totalActualEffort}h / 预估{' '}
              {stats.totalEstimatedEffort}h
            </div>
          </CardContent>
        </Card>
      </div>
          ...
          <CardContent>
            ...
            <div className='mt-4 grid grid-cols-2 gap-3'>
              {getStatusData().map((item, index) => (
                <div
                  key={index}
                  className='bg-muted/30 flex items-center space-x-2 rounded-lg p-2'
                >
                  <div
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>各项目的需求数量分布</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>各负责人的需求数量分布</CardDescription>
          </CardHeader>
          <CardContent>
            <div className='space-y-3'>
          ...
          <CardContent>
            <div className='space-y-4'>
              ...
              <div>
                ...
                <Progress
                  value={(stats.averageEstimatedEffort / 100) * 100}
                  className='mt-2'
                />
              </div>
            </div>
